...
export const rowChoices: (WeaponComparisonRow | Divider)[] = [
    ...
    {
        id: 'f-dmg',
        label: 'Damage per bullet, body',
        extract: (s) => s.bulletDamage(),
        display: asRaw,
    },
    {
        id: 'f-spr',
        label: 'Bullets per round (spread)',
        extract: (s) => s.mode.spread,
        display: asRaw,
    },
    ...
    { id: 'f-rpm', label: 'Rounds per minute', extract: (s) => s.rpm(), display: asRaw },
    {
        ...
        extract: (s) => s.headshotMultiplier(),
        display: asPercent,
    },
    {
        id: 'f-leg',
        label: 'Legshot multiplier',
        extract: (s) => s.legshotMultiplier(),
        display: asPercent,
    },
    {
        id: 'f-adsm',
        label: 'ADS move speed',
        extract: (s) => s.weapon.ads_move,
        display: asPercent,
    },
    ...
    { id: 'd-dps', label: 'Damage per second', extract: (s) => s.dps(), display: asTwoDecimal },
    {
        id: 'd-dps-head',
        label: 'Headshot damage per second',
        extract: (s) => s.dpsHeadshot(),
        display: asTwoDecimal,
    },
    {
        id: 'd-dps-leg',
        label: 'Legshot damage per second',
        extract: (s) => s.dpsLegshot(),
        display: asTwoDecimal,
    },
    { id: 'd-mag', label: 'Damage per magazine', extract: (s) => s.clipDamage(), display: asRaw },
    {
        id: 'd-mag-head',
        label: 'Headshot damage per magazine',
        extract: (s) => s.clipHeadshot(),
        display: asRaw,
    },
    {
        id: 'd-mag-leg',
        label: 'Legshot damage per magazine',
        extract: (s) => s.clipLegshot(),
        display: asRaw,
    },
    ...
    {
        id: 'h-mag-time',
        label: 'Time to empty magazine (s)',
        extract: (s) => s.clipTimeSeconds(),
        display: asTwoDecimal,
    },
