...
export const rowChoices: (WeaponComparisonRow | Divider)[] = [
    ...
    { id: 'd-dps-head', label: 'Headshot damage per second', extract: s => s.dpsHeadshot(), display: asTwoDecimal },
    { id: 'd-dps-leg', label: 'Legshot damage per second', extract: s => s.dpsLegshot(), display: asTwoDecimal },
